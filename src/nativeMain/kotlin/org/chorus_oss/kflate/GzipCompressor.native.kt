...
internal class NativeGzipCompressor : Compressor {
    override fun compress(data: ByteArray): ByteArray {
        ...
        memScoped {
            ...
            if (code != Z_OK) throw IOException("gzip compression failed, code: $code")
            ...
            try {
                ...
                do {
                    ...
                    if (code != Z_OK && code != Z_STREAM_END) throw IOException("gzip compression failed, code: $code")
...
internal actual fun platformGzipCompressor(): Compressor = NativeGzipCompressor()