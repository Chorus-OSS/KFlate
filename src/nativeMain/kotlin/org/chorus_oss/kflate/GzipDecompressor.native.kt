...
internal class NativeGzipDecompressor : Decompressor {
    override fun decompress(data: ByteArray): ByteArray {
        ...
        memScoped {
            ...
            if (code != Z_OK) throw IOException("gzip decompression failed, code: $code")
            ...
            try {
                ...
                do {
                    ...
                    if (code != Z_OK && code != Z_STREAM_END) throw IOException("gzip decompression failed, code: $code")
...
internal actual fun platformGzipDecompressor(): Decompressor = NativeGzipDecompressor()